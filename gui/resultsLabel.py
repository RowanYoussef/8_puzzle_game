...
class Results(ctk.CTkLabel):
    def __init__(self, master, **kwargs):
        ...
        self.time_label = ctk.CTkLabel(master, text="Time: 0.0 ms",font=("Arial", 16))
        self.time_label.grid(row=1, column=1, padx=10, pady=5, sticky="e")

        self.depth_label = ctk.CTkLabel(master, text="Depth: 0",font=("Arial", 16))
        self.depth_label.grid(row=2, column=1, padx=10, pady=5, sticky="e")

        self.cost_label = ctk.CTkLabel(master, text="Cost: 0",font=("Arial", 16))
        self.cost_label.grid(row=3, column=1, padx=10, pady=5, sticky="e")

        self.expanded_label = ctk.CTkLabel(master, text="Expanded Nodes: 0",font=("Arial", 16))
